...
public class ActivityListView extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<Comment> mStrings = new ArrayList<>();
    ...
    private void inflateListViews() {
        ...
        if (mFlag) {
            for (CharSequence cs : mPoems) {
                ...
                comment.setContent(cs.toString());
                mStrings.add(comment);
            }
        } else {
    ...
    class TheBaseAdapter extends BaseAdapter implements ExpandableTextView.OnExpandListener {
        ...
        public TheBaseAdapter(Context context, List<Comment> list) {
            mList = list;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Integer state = getItem(position).getState();
        ...
        public void onExpand(ExpandableTextView view) {
            ...
            if (obj != null && obj instanceof Integer) {
                getItem((Integer) obj).setState(view.getExpandState());
            }
        }
